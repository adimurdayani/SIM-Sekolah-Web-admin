...
<head>
    ...
    <link rel="shrotcut icon" href="{{ asset('img/logo_sekolah.png') }}">
</head>
...
<body class="hold-transition login-page" style="background-image: url('{{ asset('img/wallup.jpg') }}'); background-size: cover; background-attachment: fixed;">
    <div class="login-box">
        <div class="login-logo">
            <img src="{{ asset('img/smkmadani.png') }}" class="position-relative" width="100%" alt="">
        </div>
        ...
        <footer style="color: white;">
            <marquee>
                ...
                </script> &diams; <a href="#" style="color: white;">SMK KOMPUTER MADANI MALANGKE</a>. </strong>
            </marquee>
        </footer>
    </div>
